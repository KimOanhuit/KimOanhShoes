<?php
	...
	require 'database_config.php';
							...
							$sql = "SELECT MaSanPham, TenSanPham, KieuSanPham, GiaSanPham, HinhAnh FROM sanpham ORDER BY MaSanPham DESC LIMIT $page_num , $per_page";
							...
							echo '<li><a href="index.php?page=1">Trang đầu</a></li>';
							if($page >= 2){
								$i = $page - 1;
							}
							else $i = 1;
							...
							echo '<li><a href="index.php?page='.$num_of_page.'">Trang cuối</a></li>';
